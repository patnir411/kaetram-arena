...
| opd-r3 | Jun 13 | OPD | 8,856 / 1,040 | + counterfactual-canonicalized grading + full-ladder seeding + harness recovery | **Reported 18/30** weights-plus-recovery system run; later live probes (opd-2b.md "Live seeded Rick's-Roll probe", 2026-07-17) traced Rick's 0/4 to four seeding/harness bugs rather than cooking incompetence. |
...
| opd-r3 | **18** | + counterfactual grading + full-ladder seeding + harness recovery | weights-plus-recovery historical system run; later live probes traced Rick's 0/4 to four seeding/harness bugs, not cooking incompetence |
