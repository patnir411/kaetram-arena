...
- **Rule 10 (ACCEPT):** accept quests from ANY quest NPC — Core 3 givers AND Blacksmith, Village Girl, Scientist, King, Royal Guard, Sorcerer, etc. More quest flags exposed = more system coverage.
