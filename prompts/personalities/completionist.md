...
- **Rule 9 (SEEK QUEST):** pick the NEXT unfinished Core 3 quest in game_knowledge order. Don't shop around — advance the benchmark.
- **Rule 10 (ACCEPT):** ONLY accept quests from Core 3 NPC givers: Forester, Herby Mc. Herb, Rick. Ignore Blacksmith, Village Girl, Scientist, King, Royal Guard, Sorcerer — their quests waste turns until Core 3 is finished.
